...
public class CardSliderLayoutManager extends RecyclerView.LayoutManager
    ...
    private void initialize(int left, int width, float gap, @Nullable CardSliderLayoutManager.ViewUpdater updater) {
        ...
        if (this.viewUpdater == null) {
            this.viewUpdater = (ViewUpdater) new DefaultViewUpdater();
        }
        viewUpdater.onLayoutManagerInitialized(CardSliderLayoutManager.this);
    }
    ...
    private ViewUpdater loadViewUpdater(Context context, String className, AttributeSet attrs) {
        ...
        if (className.charAt(0) == '.') {
            ...
            fullClassName = Objects.requireNonNull(CardSliderLayoutManager.class.getPackage()).getName() + '.' + className;
        }
